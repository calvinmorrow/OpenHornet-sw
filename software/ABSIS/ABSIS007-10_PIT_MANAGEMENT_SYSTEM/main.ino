...
/**
 * @file <sketchName.ino>
 * @author Calvin Morrow
 * @date Oct 09 2023
 * @brief ABSIS Pit Management System
 *
 */
#define PIN_PWR_OK A9
#define PIN_PS_ON A8
#define PIN_SIMPWR_MASTERON A1
...
void setup() {
  ...
  pinMode(PIN_SIMPWR_MASTERON, INPUT_PULLUP);
...
*/
void loop() {
  if ((digitalRead(PIN_PWR_OK) == HIGH) && (digitalRead(PIN_SIMPWR_MASTERON) == LOW)) {
